...
stdenv.mkDerivation rec {
  ...
  patches =
    [ ./keep-path.patch
      ...
      dots_in_usernames
      (fetchpatch {
        url = https://github.com/shadow-maint/shadow/commit/f019f8ffcbba5d5b4674a2eced25e869bd0162d3.patch;
        sha256 = "1cdmpzyyij562g29cnvjbcq8vgvrkhchaz8671vah1r1a6brqjgx";
      })
    ];
