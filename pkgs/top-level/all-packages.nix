...
in
{
  ...
  libsForQt512 = recurseIntoAttrs (import ./qt-packages.nix {
    inherit lib pkgs;
    qt5 = qt512;
    });

  libsForQt514 = recurseIntoAttrs (import ./qt-packages.nix {
    inherit lib pkgs;
    qt5 = qt514;
  });

  libsForQt515 = recurseIntoAttrs (import ./qt-packages.nix {
    inherit lib pkgs;
    qt5 = qt515;
  });
